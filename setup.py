...
if __name__ == '__main__':
    ...
    write_version_py('steemhistory/version.py')

    setup(
        name='steemhistory',
        version=VERSION,
        description='command line tool for obtaining and processing account history of a steem account',
        ...
        entry_points={
            'console_scripts': [
                'steemhistory=steemhistory.cli:main',
            ],
        },
